...
ALTER TABLE "room_player_results" ADD CONSTRAINT "room_player_results_room_player_id_room_players_id_fk" FOREIGN KEY ("room_player_id") REFERENCES "public"."room_players"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
