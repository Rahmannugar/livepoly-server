...
ALTER TABLE "room_results" ADD CONSTRAINT "room_results_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "livepoly"."games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
