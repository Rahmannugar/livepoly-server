  ...
  StartRoom: () =>
    applyDecorators(
      ...
      ApiOperation({
        summary: 'Start room',
        description:
          'Starts a waiting room. Three or more human players start ranked with the fixed 60 minute ranked duration. Fewer than three human players are filled with bots and start casual using the selected 90 or 120 minute room duration.',
      }),
      ApiParam({ name: 'code', example: 'AbC23xYz' }),
      ApiBody({
        type: StartRoomDto,
